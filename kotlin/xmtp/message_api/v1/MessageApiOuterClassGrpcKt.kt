...
import xmtp.message_api.v1.MessageApiGrpc.getServiceDescriptor
...
public object MessageApiGrpcKt {
  ...
  public val publishMethod:
      MethodDescriptor<MessageApiOuterClass.PublishRequest, MessageApiOuterClass.PublishResponse>
    @JvmStatic
    get() = MessageApiGrpc.getPublishMethod()

  public val subscribeMethod:
      MethodDescriptor<MessageApiOuterClass.SubscribeRequest, MessageApiOuterClass.Envelope>
    @JvmStatic
    get() = MessageApiGrpc.getSubscribeMethod()

  public val subscribeAllMethod:
      MethodDescriptor<MessageApiOuterClass.SubscribeAllRequest, MessageApiOuterClass.Envelope>
    @JvmStatic
    get() = MessageApiGrpc.getSubscribeAllMethod()

  public val queryMethod:
      MethodDescriptor<MessageApiOuterClass.QueryRequest, MessageApiOuterClass.QueryResponse>
    @JvmStatic
  ...
  public class MessageApiCoroutineStub @JvmOverloads constructor(
    ...
    public fun subscribe(request: MessageApiOuterClass.SubscribeRequest, headers: Metadata =
        Metadata()): Flow<MessageApiOuterClass.Envelope> = serverStreamingRpc(
      channel,
  ...
  public abstract class MessageApiCoroutineImplBase(
    ...
    public open fun subscribe(request: MessageApiOuterClass.SubscribeRequest):
        Flow<MessageApiOuterClass.Envelope> = throw
