...
// Get messages filter types
type GetMessagesFilterType int32

const (
	GetMessagesFilterType_GET_MESSAGES_FILTER_TYPE_UNSPECIFIED GetMessagesFilterType = 0
	GetMessagesFilterType_GET_MESSAGES_FILTER_TYPE_LATEST      GetMessagesFilterType = 1
	GetMessagesFilterType_GET_MESSAGES_FILTER_TYPE_CURSOR      GetMessagesFilterType = 2
)

// Enum value maps for GetMessagesFilterType.
var (
	GetMessagesFilterType_name = map[int32]string{
		0: "GET_MESSAGES_FILTER_TYPE_UNSPECIFIED",
		1: "GET_MESSAGES_FILTER_TYPE_LATEST",
		2: "GET_MESSAGES_FILTER_TYPE_CURSOR",
	}
	GetMessagesFilterType_value = map[string]int32{
		"GET_MESSAGES_FILTER_TYPE_UNSPECIFIED": 0,
		"GET_MESSAGES_FILTER_TYPE_LATEST":      1,
		"GET_MESSAGES_FILTER_TYPE_CURSOR":      2,
	}
)

func (x GetMessagesFilterType) Enum() *GetMessagesFilterType {
	p := new(GetMessagesFilterType)
	*p = x
	return p
}

func (x GetMessagesFilterType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GetMessagesFilterType) Descriptor() protoreflect.EnumDescriptor {
	return file_mls_api_v1_mls_proto_enumTypes[0].Descriptor()
}

func (GetMessagesFilterType) Type() protoreflect.EnumType {
	return &file_mls_api_v1_mls_proto_enumTypes[0]
}

func (x GetMessagesFilterType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GetMessagesFilterType.Descriptor instead.
func (GetMessagesFilterType) EnumDescriptor() ([]byte, []int) {
...
type SendGroupMessageRequest struct {
	...
	Message *GroupMessageInput `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *SendGroupMessageRequest) GetMessage() *GroupMessageInput {
	if x != nil {
		return x.Message
	}
	return nil
...
// Request for sending a welcome message
type SendWelcomeMessageRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Message *WelcomeMessageInput `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *SendWelcomeMessageRequest) GetMessage() *WelcomeMessageInput {
	if x != nil {
		return x.Message
	}
	return nil
...
// Response from sending a welcome message
type SendWelcomeMessageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Message *WelcomeMessage `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *SendWelcomeMessageResponse) GetMessage() *WelcomeMessage {
	if x != nil {
		return x.Message
	}
	return nil
...
// Request for getting group messages
type GetGroupMessagesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Filters []*GetGroupMessagesRequest_Filter `protobuf:"bytes,1,rep,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *GetGroupMessagesRequest) GetFilters() []*GetGroupMessagesRequest_Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
// Request for getting welcome messages
type GetWelcomeMessagesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Filters []*GetWelcomeMessagesRequest_Filter `protobuf:"bytes,1,rep,name=filters,proto3" json:"filters,omitempty"`
}

func (x *GetWelcomeMessagesRequest) Reset() {
	*x = GetWelcomeMessagesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetWelcomeMessagesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWelcomeMessagesRequest) ProtoMessage() {}

func (x *GetWelcomeMessagesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_mls_api_v1_mls_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWelcomeMessagesRequest.ProtoReflect.Descriptor instead.
func (*GetWelcomeMessagesRequest) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{18}
}

func (x *GetWelcomeMessagesRequest) GetFilters() []*GetWelcomeMessagesRequest_Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *GroupMessageInput_V1) GetGroupId() []byte {
	if x != nil {
		return x.GroupId
	}
	return nil
...
func (*FetchKeyPackagesResponse_KeyPackage) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{13, 0}
}
...
func (*GetIdentityUpdatesResponse_RevokedInstallationUpdate) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{16, 1}
}
...
func (*GetIdentityUpdatesResponse_Update) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{16, 2}
}
...
func (*GetIdentityUpdatesResponse_WalletUpdates) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{16, 3}
}
...
// Get group messages filter
type GetGroupMessagesRequest_Filter struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GroupId  []byte                `protobuf:"bytes,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	Type     GetMessagesFilterType `protobuf:"varint,2,opt,name=type,proto3,enum=xmtp.mls.api.v1.GetMessagesFilterType" json:"type,omitempty"`
	IdCursor uint64                `protobuf:"varint,3,opt,name=id_cursor,json=idCursor,proto3" json:"id_cursor,omitempty"`
}

func (x *GetGroupMessagesRequest_Filter) Reset() {
	*x = GetGroupMessagesRequest_Filter{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetGroupMessagesRequest_Filter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGroupMessagesRequest_Filter) ProtoMessage() {}

func (x *GetGroupMessagesRequest_Filter) ProtoReflect() protoreflect.Message {
	mi := &file_mls_api_v1_mls_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGroupMessagesRequest_Filter.ProtoReflect.Descriptor instead.
func (*GetGroupMessagesRequest_Filter) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{17, 0}
}

func (x *GetGroupMessagesRequest_Filter) GetGroupId() []byte {
	if x != nil {
		return x.GroupId
	}
	return nil
...
func (x *GetGroupMessagesRequest_Filter) GetType() GetMessagesFilterType {
	if x != nil {
		return x.Type
	}
	return GetMessagesFilterType_GET_MESSAGES_FILTER_TYPE_UNSPECIFIED
}

func (x *GetGroupMessagesRequest_Filter) GetIdCursor() uint64 {
	if x != nil {
		return x.IdCursor
	}
	return 0
...
// Get welcome mesages filter
type GetWelcomeMessagesRequest_Filter struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetWelcomeMessagesRequest_Filter) Reset() {
	*x = GetWelcomeMessagesRequest_Filter{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetWelcomeMessagesRequest_Filter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWelcomeMessagesRequest_Filter) ProtoMessage() {}

func (x *GetWelcomeMessagesRequest_Filter) ProtoReflect() protoreflect.Message {
	mi := &file_mls_api_v1_mls_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWelcomeMessagesRequest_Filter.ProtoReflect.Descriptor instead.
func (*GetWelcomeMessagesRequest_Filter) Descriptor() ([]byte, []int) {
	return file_mls_api_v1_mls_proto_rawDescGZIP(), []int{18, 0}
}

func (x *GetWelcomeMessagesRequest_Filter) GetInstallationKey() []byte {
	if x != nil {
		return x.InstallationKey
	}
	return nil
...
func (x *GetWelcomeMessagesRequest_Filter) GetType() GetMessagesFilterType {
	if x != nil {
		return x.Type
	}
	return GetMessagesFilterType_GET_MESSAGES_FILTER_TYPE_UNSPECIFIED
...
func (x *GetWelcomeMessagesRequest_Filter) GetIdCursor() uint64 {
	if x != nil {
		return x.IdCursor
	}
	return 0
...
var file_mls_api_v1_mls_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x22, 0x8c, 0x01, 0x0a, 0x11, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x12, 0x37, 0x0a, 0x02, 0x76, 0x31, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x6c, 0x73,
	...
	0x76, 0x31, 0x1a, 0x33, 0x0a, 0x02, 0x56, 0x31, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75,
	0x70, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75,
	0x70, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x09, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x22, 0x57, 0x0a, 0x17, 0x53, 0x65, 0x6e, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4d,
	...
	0x75, 0x74, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x53, 0x0a, 0x18, 0x53,
	...
	0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e,
	...
	0x22, 0x5b, 0x0a, 0x19, 0x53, 0x65, 0x6e, 0x64, 0x57, 0x65, 0x6c, 0x63, 0x6f, 0x6d, 0x65, 0x4d,
	...
	0x6e, 0x70, 0x75, 0x74, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x57, 0x0a,
	...
	0x65, 0x6c, 0x63, 0x6f, 0x6d, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x07, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x4f, 0x0a, 0x10, 0x4b, 0x65, 0x79, 0x50, 0x61, 0x63,
	...
	,
	...
	0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x22, 0x5d, 0x0a, 0x17, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x4b,
	...
	0x6b, 0x61, 0x67, 0x65, 0x22, 0x46, 0x0a, 0x17, 0x46, 0x65, 0x74, 0x63, 0x68, 0x4b, 0x65, 0x79,
	...
	0x74, 0x65, 0x73, 0x22, 0xe2, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x49, 0x0a, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x2f, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x6c, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x72, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x1a, 0x7c, 0x0a, 0x06, 0x46, 0x69,
	...
	0x47, 0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x69,
	0x64, 0x5f, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08,
	0x69, 0x64, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xf7, 0x01, 0x0a, 0x19, 0x47, 0x65, 0x74,
	...
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d,
	0x6c, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x57, 0x65, 0x6c,
	...
	,
	...
	0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x78, 0x6d, 0x74,
	...
	0x6d, 0x6c, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x65, 0x6e, 0x64, 0x2d, 0x67, 0x72, 0x6f, 0x75,
	0x70, 0x2d, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x84, 0x01, 0x0a,
	...
	0x6f, 0x75, 0x70, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x25, 0x82, 0xd3, 0xe4, 0x93,
	0x02, 0x1f, 0x22, 0x1a, 0x2f, 0x6d, 0x6c, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65, 0x74, 0x2d,
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x2d, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x3a, 0x01,
	0x2a, 0x30, 0x01, 0x12, 0x96, 0x01, 0x0a, 0x12, 0x53, 0x65, 0x6e, 0x64, 0x57, 0x65, 0x6c, 0x63,
	0x6f, 0x6d, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x2a, 0x2e, 0x78, 0x6d, 0x74,
	0x70, 0x2e, 0x6d, 0x6c, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x6e,
	0x64, 0x57, 0x65, 0x6c, 0x63, 0x6f, 0x6d, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52,
	...
	0x6e, 0x73, 0x65, 0x22, 0x27, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x21, 0x22, 0x1c, 0x2f, 0x6d, 0x6c,
	0x73, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x65, 0x6e, 0x64, 0x2d, 0x77, 0x65, 0x6c, 0x63, 0x6f, 0x6d,
	0x65, 0x2d, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x8c, 0x01, 0x0a,
	0x12, 0x47, 0x65, 0x74, 0x57, 0x65, 0x6c, 0x63, 0x6f, 0x6d, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x73, 0x12, 0x2a, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x6c, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x57, 0x65, 0x6c, 0x63, 0x6f, 0x6d, 0x65,
	...
	0x22, 0x27, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x21, 0x22, 0x1c, 0x2f, 0x6d, 0x6c, 0x73, 0x2f, 0x76,
	0x31, 0x2f, 0x67, 0x65, 0x74, 0x2d, 0x77, 0x65, 0x6c, 0x63, 0x6f, 0x6d, 0x65, 0x2d, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x3a, 0x01, 0x2a, 0x30, 0x01, 0x12, 0x9d, 0x01, 0x0a, 0x14,
	0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2c, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x6c, 0x73, 0x2e,
	...
	,
	...
	0x73, 0x65, 0x22, 0x25, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1f, 0x22, 0x1a, 0x2f, 0x6d, 0x6c, 0x73,
	0x2f, 0x76, 0x31, 0x2f, 0x66, 0x65, 0x74, 0x63, 0x68, 0x2d, 0x6b, 0x65, 0x79, 0x2d, 0x70, 0x61,
	0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x80, 0x01, 0x0a, 0x12, 0x52, 0x65,
	...
	0x74, 0x61, 0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x3a, 0x01, 0x2a, 0x12, 0x96, 0x01, 0x0a,
	0x12, 0x47, 0x65, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x73, 0x12, 0x2a, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x6c, 0x73, 0x2e, 0x61,
	...
	0xe4, 0x93, 0x02, 0x21, 0x22, 0x1c, 0x2f, 0x6d, 0x6c, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65,
	0x74, 0x2d, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2d, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x55, 0x0a, 0x19, 0x6f, 0x72, 0x67, 0x2e, 0x78, 0x6d, 0x74,
...
var file_mls_api_v1_mls_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_mls_api_v1_mls_proto_goTypes = []interface{}{
	(GetMessagesFilterType)(0),                                   // 0: xmtp.mls.api.v1.GetMessagesFilterType
	...
	(*SendGroupMessageRequest)(nil),                              // 5: xmtp.mls.api.v1.SendGroupMessageRequest
	(*SendGroupMessageResponse)(nil),                             // 6: xmtp.mls.api.v1.SendGroupMessageResponse
	(*SendWelcomeMessageRequest)(nil),                            // 7: xmtp.mls.api.v1.SendWelcomeMessageRequest
	(*SendWelcomeMessageResponse)(nil),                           // 8: xmtp.mls.api.v1.SendWelcomeMessageResponse
	...
	(*GetGroupMessagesRequest)(nil),                              // 18: xmtp.mls.api.v1.GetGroupMessagesRequest
	(*GetWelcomeMessagesRequest)(nil),                            // 19: xmtp.mls.api.v1.GetWelcomeMessagesRequest
	(*WelcomeMessage_V1)(nil),                                    // 20: xmtp.mls.api.v1.WelcomeMessage.V1
	(*WelcomeMessageInput_V1)(nil),                               // 21: xmtp.mls.api.v1.WelcomeMessageInput.V1
	(*GroupMessage_V1)(nil),                                      // 22: xmtp.mls.api.v1.GroupMessage.V1
	(*GroupMessageInput_V1)(nil),                                 // 23: xmtp.mls.api.v1.GroupMessageInput.V1
	(*FetchKeyPackagesResponse_KeyPackage)(nil),                  // 24: xmtp.mls.api.v1.FetchKeyPackagesResponse.KeyPackage
	(*GetIdentityUpdatesResponse_NewInstallationUpdate)(nil),     // 25: xmtp.mls.api.v1.GetIdentityUpdatesResponse.NewInstallationUpdate
	(*GetIdentityUpdatesResponse_RevokedInstallationUpdate)(nil), // 26: xmtp.mls.api.v1.GetIdentityUpdatesResponse.RevokedInstallationUpdate
	(*GetIdentityUpdatesResponse_Update)(nil),                    // 27: xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update
	(*GetIdentityUpdatesResponse_WalletUpdates)(nil),             // 28: xmtp.mls.api.v1.GetIdentityUpdatesResponse.WalletUpdates
	(*GetGroupMessagesRequest_Filter)(nil),                       // 29: xmtp.mls.api.v1.GetGroupMessagesRequest.Filter
	(*GetWelcomeMessagesRequest_Filter)(nil),                     // 30: xmtp.mls.api.v1.GetWelcomeMessagesRequest.Filter
	(*message_contents.Signature)(nil),                           // 31: xmtp.message_contents.Signature
	(*emptypb.Empty)(nil),                                        // 32: google.protobuf.Empty
}
var file_mls_api_v1_mls_proto_depIdxs = []int32{
	20, // 0: xmtp.mls.api.v1.WelcomeMessage.v1:type_name -> xmtp.mls.api.v1.WelcomeMessage.V1
	21, // 1: xmtp.mls.api.v1.WelcomeMessageInput.v1:type_name -> xmtp.mls.api.v1.WelcomeMessageInput.V1
	22, // 2: xmtp.mls.api.v1.GroupMessage.v1:type_name -> xmtp.mls.api.v1.GroupMessage.V1
	23, // 3: xmtp.mls.api.v1.GroupMessageInput.v1:type_name -> xmtp.mls.api.v1.GroupMessageInput.V1
	4,  // 4: xmtp.mls.api.v1.SendGroupMessageRequest.message:type_name -> xmtp.mls.api.v1.GroupMessageInput
	3,  // 5: xmtp.mls.api.v1.SendGroupMessageResponse.message:type_name -> xmtp.mls.api.v1.GroupMessage
	2,  // 6: xmtp.mls.api.v1.SendWelcomeMessageRequest.message:type_name -> xmtp.mls.api.v1.WelcomeMessageInput
	1,  // 7: xmtp.mls.api.v1.SendWelcomeMessageResponse.message:type_name -> xmtp.mls.api.v1.WelcomeMessage
	...
	24, // 10: xmtp.mls.api.v1.FetchKeyPackagesResponse.key_packages:type_name -> xmtp.mls.api.v1.FetchKeyPackagesResponse.KeyPackage
	31, // 11: xmtp.mls.api.v1.RevokeInstallationRequest.wallet_signature:type_name -> xmtp.message_contents.Signature
	28, // 12: xmtp.mls.api.v1.GetIdentityUpdatesResponse.updates:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.WalletUpdates
	29, // 13: xmtp.mls.api.v1.GetGroupMessagesRequest.filters:type_name -> xmtp.mls.api.v1.GetGroupMessagesRequest.Filter
	30, // 14: xmtp.mls.api.v1.GetWelcomeMessagesRequest.filters:type_name -> xmtp.mls.api.v1.GetWelcomeMessagesRequest.Filter
	25, // 15: xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update.new_installation:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.NewInstallationUpdate
	26, // 16: xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update.revoked_installation:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.RevokedInstallationUpdate
	27, // 17: xmtp.mls.api.v1.GetIdentityUpdatesResponse.WalletUpdates.updates:type_name -> xmtp.mls.api.v1.GetIdentityUpdatesResponse.Update
	0,  // 18: xmtp.mls.api.v1.GetGroupMessagesRequest.Filter.type:type_name -> xmtp.mls.api.v1.GetMessagesFilterType
	0,  // 19: xmtp.mls.api.v1.GetWelcomeMessagesRequest.Filter.type:type_name -> xmtp.mls.api.v1.GetMessagesFilterType
	5,  // 20: xmtp.mls.api.v1.MlsApi.SendGroupMessage:input_type -> xmtp.mls.api.v1.SendGroupMessageRequest
	18, // 21: xmtp.mls.api.v1.MlsApi.GetGroupMessages:input_type -> xmtp.mls.api.v1.GetGroupMessagesRequest
	7,  // 22: xmtp.mls.api.v1.MlsApi.SendWelcomeMessage:input_type -> xmtp.mls.api.v1.SendWelcomeMessageRequest
	19, // 23: xmtp.mls.api.v1.MlsApi.GetWelcomeMessages:input_type -> xmtp.mls.api.v1.GetWelcomeMessagesRequest
	10, // 24: xmtp.mls.api.v1.MlsApi.RegisterInstallation:input_type -> xmtp.mls.api.v1.RegisterInstallationRequest
	12, // 25: xmtp.mls.api.v1.MlsApi.UploadKeyPackage:input_type -> xmtp.mls.api.v1.UploadKeyPackageRequest
	13, // 26: xmtp.mls.api.v1.MlsApi.FetchKeyPackages:input_type -> xmtp.mls.api.v1.FetchKeyPackagesRequest
	15, // 27: xmtp.mls.api.v1.MlsApi.RevokeInstallation:input_type -> xmtp.mls.api.v1.RevokeInstallationRequest
	16, // 28: xmtp.mls.api.v1.MlsApi.GetIdentityUpdates:input_type -> xmtp.mls.api.v1.GetIdentityUpdatesRequest
	6,  // 29: xmtp.mls.api.v1.MlsApi.SendGroupMessage:output_type -> xmtp.mls.api.v1.SendGroupMessageResponse
	3,  // 30: xmtp.mls.api.v1.MlsApi.GetGroupMessages:output_type -> xmtp.mls.api.v1.GroupMessage
	8,  // 31: xmtp.mls.api.v1.MlsApi.SendWelcomeMessage:output_type -> xmtp.mls.api.v1.SendWelcomeMessageResponse
	1,  // 32: xmtp.mls.api.v1.MlsApi.GetWelcomeMessages:output_type -> xmtp.mls.api.v1.WelcomeMessage
	11, // 33: xmtp.mls.api.v1.MlsApi.RegisterInstallation:output_type -> xmtp.mls.api.v1.RegisterInstallationResponse
	32, // 34: xmtp.mls.api.v1.MlsApi.UploadKeyPackage:output_type -> google.protobuf.Empty
	14, // 35: xmtp.mls.api.v1.MlsApi.FetchKeyPackages:output_type -> xmtp.mls.api.v1.FetchKeyPackagesResponse
	32, // 36: xmtp.mls.api.v1.MlsApi.RevokeInstallation:output_type -> google.protobuf.Empty
	17, // 37: xmtp.mls.api.v1.MlsApi.GetIdentityUpdates:output_type -> xmtp.mls.api.v1.GetIdentityUpdatesResponse
...
func file_mls_api_v1_mls_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mls_api_v1_mls_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SendWelcomeMessageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_api_v1_mls_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SendWelcomeMessageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_api_v1_mls_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetWelcomeMessagesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_api_v1_mls_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetGroupMessagesRequest_Filter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mls_api_v1_mls_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetWelcomeMessagesRequest_Filter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_mls_api_v1_mls_proto_msgTypes[26].OneofWrappers = []interface{}{
