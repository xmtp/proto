...
type SignedSendKeyPrivateKey struct {
	...
	//
	//	*SignedSendKeyPrivateKey_Secp256K1_
	Union isSignedSendKeyPrivateKey_Union `protobuf_oneof:"union"`
	// public key for this private key
	PublicKey *SignedSendKeyPublicKey `protobuf:"bytes,3,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
}

func (x *SignedSendKeyPrivateKey) Reset() {
	*x = SignedSendKeyPrivateKey{}
...
func (x *SignedSendKeyPrivateKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedSendKeyPrivateKey) ProtoMessage() {}

func (x *SignedSendKeyPrivateKey) ProtoReflect() protoreflect.Message {
	mi := &file_message_contents_private_key_proto_msgTypes[0]
...
// Deprecated: Use SignedSendKeyPrivateKey.ProtoReflect.Descriptor instead.
func (*SignedSendKeyPrivateKey) Descriptor() ([]byte, []int) {
	return file_message_contents_private_key_proto_rawDescGZIP(), []int{0}
}

func (x *SignedSendKeyPrivateKey) GetCreatedNs() uint64 {
	if x != nil {
		return x.CreatedNs
	}
	return 0
...
func (m *SignedSendKeyPrivateKey) GetUnion() isSignedSendKeyPrivateKey_Union {
	if m != nil {
		return m.Union
	}
	return nil
...
func (x *SignedSendKeyPrivateKey) GetSecp256K1() *SignedSendKeyPrivateKey_Secp256K1 {
	if x, ok := x.GetUnion().(*SignedSendKeyPrivateKey_Secp256K1_); ok {
		return x.Secp256K1
	}
	return nil
}

func (x *SignedSendKeyPrivateKey) GetPublicKey() *SignedSendKeyPublicKey {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
type isSignedSendKeyPrivateKey_Union interface {
	isSignedSendKeyPrivateKey_Union()
}

type SignedSendKeyPrivateKey_Secp256K1_ struct {
	Secp256K1 *SignedSendKeyPrivateKey_Secp256K1 `protobuf:"bytes,2,opt,name=secp256k1,proto3,oneof"`
}

func (*SignedSendKeyPrivateKey_Secp256K1_) isSignedSendKeyPrivateKey_Union() {}
...
// EC: SECP256k1
type SignedSendKeyPrivateKey_Secp256K1 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SignedSendKeyPrivateKey_Secp256K1) Reset() {
	*x = SignedSendKeyPrivateKey_Secp256K1{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedSendKeyPrivateKey_Secp256K1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedSendKeyPrivateKey_Secp256K1) ProtoMessage() {}

func (x *SignedSendKeyPrivateKey_Secp256K1) ProtoReflect() protoreflect.Message {
	mi := &file_message_contents_private_key_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedSendKeyPrivateKey_Secp256K1.ProtoReflect.Descriptor instead.
func (*SignedSendKeyPrivateKey_Secp256K1) Descriptor() ([]byte, []int) {
	return file_message_contents_private_key_proto_rawDescGZIP(), []int{0, 0}
}

func (x *SignedSendKeyPrivateKey_Secp256K1) GetBytes() []byte {
	if x != nil {
		return x.Bytes
	}
	return nil
...
func (*PrivateKey_Secp256K1) Descriptor() ([]byte, []int) {
	return file_message_contents_private_key_proto_rawDescGZIP(), []int{3, 0}
}
...
var file_message_contents_private_key_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0xf7, 0x01, 0x0a, 0x10, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x50, 0x72, 0x69, 0x76, 0x61,
	...
	0x65, 0x64, 0x4e, 0x73, 0x12, 0x51, 0x0a, 0x09, 0x73, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b,
	0x31, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d,
	...
	0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x12, 0x45, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x78, 0x6d,
	...
	,
	...
	0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x52, 0x07, 0x70, 0x72, 0x65, 0x4b, 0x65, 0x79,
	0x73, 0x22, 0xe4, 0x01, 0x0a, 0x0a, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79,
	0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x4b,
	...
	0x65, 0x4b, 0x65, 0x79, 0x2e, 0x53, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x48, 0x00,
	0x52, 0x09, 0x73, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x12, 0x3f, 0x0a, 0x0a, 0x70,
	...
	0x79, 0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x1a, 0x21, 0x0a, 0x09,
	0x53, 0x65, 0x63, 0x70, 0x32, 0x35, 0x36, 0x6b, 0x31, 0x12, 0x14, 0x0a, 0x05, 0x62, 0x79, 0x74,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x62, 0x79, 0x74, 0x65, 0x73, 0x42,
	0x07, 0x0a, 0x05, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x22, 0x98, 0x01, 0x0a, 0x12, 0x50, 0x72, 0x69,
	0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x56, 0x31, 0x12,
	0x44, 0x0a, 0x0c, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x6b, 0x65, 0x79, 0x18,
	...
	0x74, 0x79, 0x4b, 0x65, 0x79, 0x12, 0x3c, 0x0a, 0x08, 0x70, 0x72, 0x65, 0x5f, 0x6b, 0x65, 0x79,
	...
	0x65, 0x79, 0x73, 0x22, 0x97, 0x01, 0x0a, 0x10, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b,
	0x65, 0x79, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x12, 0x3b, 0x0a, 0x02, 0x76, 0x31, 0x18, 0x01,
	...
	0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x56, 0x31, 0x48,
	0x00, 0x52, 0x02, 0x76, 0x31, 0x12, 0x3b, 0x0a, 0x02, 0x76, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x29, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74,
	0x65, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x56, 0x32, 0x48, 0x00, 0x52, 0x02,
	0x76, 0x32, 0x42, 0x09, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x86, 0x01,
...
var file_message_contents_private_key_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_message_contents_private_key_proto_goTypes = []interface{}{
	(*SignedSendKeyPrivateKey)(nil),           // 0: xmtp.message_contents.SignedSendKeyPrivateKey
	(*SignedPrivateKey)(nil),                  // 1: xmtp.message_contents.SignedPrivateKey
	(*PrivateKeyBundleV2)(nil),                // 2: xmtp.message_contents.PrivateKeyBundleV2
	(*PrivateKey)(nil),                        // 3: xmtp.message_contents.PrivateKey
	(*PrivateKeyBundleV1)(nil),                // 4: xmtp.message_contents.PrivateKeyBundleV1
	(*PrivateKeyBundle)(nil),                  // 5: xmtp.message_contents.PrivateKeyBundle
	(*EncryptedPrivateKeyBundleV1)(nil),       // 6: xmtp.message_contents.EncryptedPrivateKeyBundleV1
	(*EncryptedPrivateKeyBundle)(nil),         // 7: xmtp.message_contents.EncryptedPrivateKeyBundle
	(*SignedSendKeyPrivateKey_Secp256K1)(nil), // 8: xmtp.message_contents.SignedSendKeyPrivateKey.Secp256k1
	(*SignedPrivateKey_Secp256K1)(nil),        // 9: xmtp.message_contents.SignedPrivateKey.Secp256k1
	(*PrivateKey_Secp256K1)(nil),              // 10: xmtp.message_contents.PrivateKey.Secp256k1
	(*SignedSendKeyPublicKey)(nil),            // 11: xmtp.message_contents.SignedSendKeyPublicKey
	(*SignedPublicKey)(nil),                   // 12: xmtp.message_contents.SignedPublicKey
	(*PublicKey)(nil),                         // 13: xmtp.message_contents.PublicKey
	(*Ciphertext)(nil),                        // 14: xmtp.message_contents.Ciphertext
}
var file_message_contents_private_key_proto_depIdxs = []int32{
	8,  // 0: xmtp.message_contents.SignedSendKeyPrivateKey.secp256k1:type_name -> xmtp.message_contents.SignedSendKeyPrivateKey.Secp256k1
	11, // 1: xmtp.message_contents.SignedSendKeyPrivateKey.public_key:type_name -> xmtp.message_contents.SignedSendKeyPublicKey
	9,  // 2: xmtp.message_contents.SignedPrivateKey.secp256k1:type_name -> xmtp.message_contents.SignedPrivateKey.Secp256k1
	12, // 3: xmtp.message_contents.SignedPrivateKey.public_key:type_name -> xmtp.message_contents.SignedPublicKey
	1,  // 4: xmtp.message_contents.PrivateKeyBundleV2.identity_key:type_name -> xmtp.message_contents.SignedPrivateKey
	1,  // 5: xmtp.message_contents.PrivateKeyBundleV2.pre_keys:type_name -> xmtp.message_contents.SignedPrivateKey
	10, // 6: xmtp.message_contents.PrivateKey.secp256k1:type_name -> xmtp.message_contents.PrivateKey.Secp256k1
	13, // 7: xmtp.message_contents.PrivateKey.public_key:type_name -> xmtp.message_contents.PublicKey
	3,  // 8: xmtp.message_contents.PrivateKeyBundleV1.identity_key:type_name -> xmtp.message_contents.PrivateKey
	3,  // 9: xmtp.message_contents.PrivateKeyBundleV1.pre_keys:type_name -> xmtp.message_contents.PrivateKey
	4,  // 10: xmtp.message_contents.PrivateKeyBundle.v1:type_name -> xmtp.message_contents.PrivateKeyBundleV1
	2,  // 11: xmtp.message_contents.PrivateKeyBundle.v2:type_name -> xmtp.message_contents.PrivateKeyBundleV2
	14, // 12: xmtp.message_contents.EncryptedPrivateKeyBundleV1.ciphertext:type_name -> xmtp.message_contents.Ciphertext
	6,  // 13: xmtp.message_contents.EncryptedPrivateKeyBundle.v1:type_name -> xmtp.message_contents.EncryptedPrivateKeyBundleV1
...
func file_message_contents_private_key_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_contents_private_key_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedSendKeyPrivateKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_contents_private_key_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedSendKeyPrivateKey_Secp256K1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_message_contents_private_key_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*SignedSendKeyPrivateKey_Secp256K1_)(nil),
	}
	file_message_contents_private_key_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*SignedPrivateKey_Secp256K1_)(nil),
	}
	file_message_contents_private_key_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*PrivateKey_Secp256K1_)(nil),
	}
	file_message_contents_private_key_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*PrivateKeyBundle_V1)(nil),
		(*PrivateKeyBundle_V2)(nil),
	}
	file_message_contents_private_key_proto_msgTypes[7].OneofWrappers = []interface{}{
