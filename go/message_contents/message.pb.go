...
var file_message_contents_message_proto_rawDesc = []byte{
	...
	0x6e, 0x42, 0x4f, 0x0a, 0x1f, 0x6f, 0x72, 0x67, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x70, 0x72,
...
var file_message_contents_message_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_message_contents_message_proto_goTypes = []interface{}{
	...
	(*PublicKeyBundle)(nil), // 5: xmtp.message_contents.PublicKeyBundle
	(*Ciphertext)(nil),      // 6: xmtp.message_contents.Ciphertext
}
var file_message_contents_message_proto_depIdxs = []int32{
	5, // 0: xmtp.message_contents.MessageHeaderV1.sender:type_name -> xmtp.message_contents.PublicKeyBundle
	5, // 1: xmtp.message_contents.MessageHeaderV1.recipient:type_name -> xmtp.message_contents.PublicKeyBundle
	6, // 2: xmtp.message_contents.MessageV1.ciphertext:type_name -> xmtp.message_contents.Ciphertext
	6, // 3: xmtp.message_contents.MessageV2.ciphertext:type_name -> xmtp.message_contents.Ciphertext
