...
type MessageV2 struct {
	...
	//
	//	*MessageV2_Ciphertext
	//	*MessageV2_MessageHistoryBackupRequest
	//	*MessageV2_MessageHistoryBackupResponse
...
func (m *MessageV2) GetContent() isMessageV2_Content {
	if m != nil {
		return m.Content
	}
	return nil
...
func (x *MessageV2) GetCiphertext() *Ciphertext {
	if x, ok := x.GetContent().(*MessageV2_Ciphertext); ok {
		return x.Ciphertext
	}
	return nil
}

func (x *MessageV2) GetMessageHistoryBackupRequest() *MessageHistoryBackupRequest {
	if x, ok := x.GetContent().(*MessageV2_MessageHistoryBackupRequest); ok {
		return x.MessageHistoryBackupRequest
	}
	return nil
}

func (x *MessageV2) GetMessageHistoryBackupResponse() *MessageHistoryBackupResponse {
	if x, ok := x.GetContent().(*MessageV2_MessageHistoryBackupResponse); ok {
		return x.MessageHistoryBackupResponse
	}
	return nil
}
...
type MessageV2_Ciphertext struct {
...
type MessageV2_MessageHistoryBackupRequest struct {
	MessageHistoryBackupRequest *MessageHistoryBackupRequest `protobuf:"bytes,5,opt,name=message_history_backup_request,json=messageHistoryBackupRequest,proto3,oneof"`
}

type MessageV2_MessageHistoryBackupResponse struct {
	MessageHistoryBackupResponse *MessageHistoryBackupResponse `protobuf:"bytes,6,opt,name=message_history_backup_response,json=messageHistoryBackupResponse,proto3,oneof"`
}

func (*MessageV2_Ciphertext) isMessageV2_Content() {}

func (*MessageV2_MessageHistoryBackupRequest) isMessageV2_Content() {}

func (*MessageV2_MessageHistoryBackupResponse) isMessageV2_Content() {}

type MessageHistoryBackupRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MessageHistoryBackupRequest) Reset() {
	*x = MessageHistoryBackupRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageHistoryBackupRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageHistoryBackupRequest) ProtoMessage() {}

func (x *MessageHistoryBackupRequest) ProtoReflect() protoreflect.Message {
	mi := &file_message_contents_message_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageHistoryBackupRequest.ProtoReflect.Descriptor instead.
func (*MessageHistoryBackupRequest) Descriptor() ([]byte, []int) {
	return file_message_contents_message_proto_rawDescGZIP(), []int{4}
}

func (x *MessageHistoryBackupRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
type MessageHistoryBackupResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MessageHistoryBackupResponse) Reset() {
	*x = MessageHistoryBackupResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageHistoryBackupResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageHistoryBackupResponse) ProtoMessage() {}

func (x *MessageHistoryBackupResponse) ProtoReflect() protoreflect.Message {
	mi := &file_message_contents_message_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageHistoryBackupResponse.ProtoReflect.Descriptor instead.
func (*MessageHistoryBackupResponse) Descriptor() ([]byte, []int) {
	return file_message_contents_message_proto_rawDescGZIP(), []int{5}
}

func (x *MessageHistoryBackupResponse) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *MessageHistoryBackupResponse) GetBackupUrl() string {
	if x != nil {
		return x.BackupUrl
	}
	return ""
...
func (x *MessageHistoryBackupResponse) GetBackupFileHash() []byte {
	if x != nil {
...
func (x *MessageHistoryBackupResponse) GetExpirationTimeNs() int64 {
	if x != nil {
...
var file_message_contents_message_proto_rawDesc = []byte{
	...
	0xe3, 0x03, 0x0a, 0x09, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x56, 0x32, 0x12, 0x21, 0x0a,
	...
	0x12, 0x43, 0x0a, 0x0a, 0x63, 0x69, 0x70, 0x68, 0x65, 0x72, 0x74, 0x65, 0x78, 0x74, 0x18, 0x02,
	...
	,
	...
	0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x48, 0x00,
	0x52, 0x1c, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x4e, 0x73, 0x22, 0x7c, 0x0a, 0x07, 0x4d, 0x65,
	...
	0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x4f, 0x0a, 0x1f, 0x6f, 0x72, 0x67, 0x2e,
...
var file_message_contents_message_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_message_contents_message_proto_goTypes = []interface{}{
	...
	(*MessageHistoryBackupRequest)(nil),  // 4: xmtp.message_contents.MessageHistoryBackupRequest
	(*MessageHistoryBackupResponse)(nil), // 5: xmtp.message_contents.MessageHistoryBackupResponse
	(*Message)(nil),                      // 6: xmtp.message_contents.Message
	(*DecodedMessage)(nil),               // 7: xmtp.message_contents.DecodedMessage
	(*PublicKeyBundle)(nil),              // 8: xmtp.message_contents.PublicKeyBundle
	(*Ciphertext)(nil),                   // 9: xmtp.message_contents.Ciphertext
	(*ConversationReference)(nil),        // 10: xmtp.message_contents.ConversationReference
}
var file_message_contents_message_proto_depIdxs = []int32{
	8,  // 0: xmtp.message_contents.MessageHeaderV1.sender:type_name -> xmtp.message_contents.PublicKeyBundle
	8,  // 1: xmtp.message_contents.MessageHeaderV1.recipient:type_name -> xmtp.message_contents.PublicKeyBundle
	9,  // 2: xmtp.message_contents.MessageV1.ciphertext:type_name -> xmtp.message_contents.Ciphertext
	9,  // 3: xmtp.message_contents.MessageV2.ciphertext:type_name -> xmtp.message_contents.Ciphertext
	4,  // 4: xmtp.message_contents.MessageV2.message_history_backup_request:type_name -> xmtp.message_contents.MessageHistoryBackupRequest
	5,  // 5: xmtp.message_contents.MessageV2.message_history_backup_response:type_name -> xmtp.message_contents.MessageHistoryBackupResponse
	1,  // 6: xmtp.message_contents.Message.v1:type_name -> xmtp.message_contents.MessageV1
	3,  // 7: xmtp.message_contents.Message.v2:type_name -> xmtp.message_contents.MessageV2
	10, // 8: xmtp.message_contents.DecodedMessage.conversation:type_name -> xmtp.message_contents.ConversationReference
...
func file_message_contents_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_contents_message_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageHistoryBackupRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_contents_message_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageHistoryBackupResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_message_contents_message_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*MessageV2_Ciphertext)(nil),
		(*MessageV2_MessageHistoryBackupRequest)(nil),
		(*MessageV2_MessageHistoryBackupResponse)(nil),
	}
	file_message_contents_message_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*Message_V1)(nil),
		(*Message_V2)(nil),
	}
	file_message_contents_message_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
