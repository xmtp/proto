...
const (
	Signature_SENDER_KEY_ASSOCIATION Signature_Context = 0
)

// Enum value maps for Signature_Context.
var (
	Signature_Context_name = map[int32]string{
		0: "SENDER_KEY_ASSOCIATION",
	}
...
const (
	Signature_ECDSA_SECP256K1_SHA256_UNCOMPRESSED_RSV Signature_Scheme = 0
)

// Enum value maps for Signature_Scheme.
var (
	Signature_Scheme_name = map[int32]string{
		0: "ECDSA_SECP256K1_SHA256_UNCOMPRESSED_RSV",
	}
...
func (x *Signature) GetContextPrefixed() *Signature_ContextPrefixed {
	if x, ok := x.GetUnion().(*Signature_ContextPrefixed_); ok {
		return x.ContextPrefixed
	}
	return nil
}
...
type Signature_ContextPrefixed_ struct {
	ContextPrefixed *Signature_ContextPrefixed `protobuf:"bytes,3,opt,name=context_prefixed,json=contextPrefixed,proto3,oneof"`
}
...
func (*Signature_ContextPrefixed_) isSignature_Union() {}
...
type Signature_ContextPrefixed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	PreContextMessageBytes []byte `protobuf:"bytes,2,opt,name=pre_context_message_bytes,json=preContextMessageBytes,proto3" json:"pre_context_message_bytes,omitempty"`
...
func (x *Signature_ContextPrefixed) Reset() {
	*x = Signature_ContextPrefixed{}
	if protoimpl.UnsafeEnabled {
...
func (x *Signature_ContextPrefixed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Signature_ContextPrefixed) ProtoMessage() {}

func (x *Signature_ContextPrefixed) ProtoReflect() protoreflect.Message {
	mi := &file_message_contents_signature_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Signature_ContextPrefixed.ProtoReflect.Descriptor instead.
func (*Signature_ContextPrefixed) Descriptor() ([]byte, []int) {
	return file_message_contents_signature_proto_rawDescGZIP(), []int{0, 2}
}

func (x *Signature_ContextPrefixed) GetSignatureBytes() []byte {
	if x != nil {
...
func (x *Signature_ContextPrefixed) GetPreContextMessageBytes() []byte {
	if x != nil {
		return x.PreContextMessageBytes
	}
	return nil
}

func (x *Signature_ContextPrefixed) GetScheme() Signature_Scheme {
	if x != nil {
		return x.Scheme
	}
	return Signature_ECDSA_SECP256K1_SHA256_UNCOMPRESSED_RSV
}

func (x *Signature_ContextPrefixed) GetContext() Signature_Context {
	if x != nil {
		return x.Context
	}
	return Signature_SENDER_KEY_ASSOCIATION
}
...
var file_message_contents_signature_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x97, 0x06, 0x0a, 0x09, 0x53, 0x69,
	...
	,
...
var file_message_contents_signature_proto_goTypes = []interface{}{
	...
	(*Signature_ContextPrefixed)(nil),    // 5: xmtp.message_contents.Signature.ContextPrefixed
}
var file_message_contents_signature_proto_depIdxs = []int32{
	...
	5, // 2: xmtp.message_contents.Signature.context_prefixed:type_name -> xmtp.message_contents.Signature.ContextPrefixed
	1, // 3: xmtp.message_contents.Signature.ContextPrefixed.scheme:type_name -> xmtp.message_contents.Signature.Scheme
	0, // 4: xmtp.message_contents.Signature.ContextPrefixed.context:type_name -> xmtp.message_contents.Signature.Context
...
func file_message_contents_signature_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_contents_signature_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Signature_ContextPrefixed); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_message_contents_signature_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Signature_ContextPrefixed_)(nil),
	}
	type x struct{}
