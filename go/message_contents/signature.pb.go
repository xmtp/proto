...
var file_message_contents_signature_proto_rawDesc = []byte{
	...
	0x42, 0x07, 0x0a, 0x05, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x22, 0xcd, 0x01, 0x0a, 0x1c, 0x41, 0x63,
	...
	0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xcf, 0x01, 0x0a, 0x1d, 0x41, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x64, 0x53, 0x74, 0x61, 0x74,
	0x69, 0x63, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x49, 0x0a, 0x02, 0x76,
	...
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x64, 0x53, 0x74,
	0x61, 0x74, 0x69, 0x63, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x2e, 0x56, 0x31,
	...
	,
	...
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x4f, 0x0a, 0x1f, 0x6f, 0x72, 0x67, 0x2e, 0x78,
...
var file_message_contents_signature_proto_goTypes = []interface{}{
	...
	(*AccountLinkedStaticSignature)(nil),     // 1: xmtp.message_contents.AccountLinkedStaticSignature
	(*AccountRevokedStaticSignature)(nil),    // 2: xmtp.message_contents.AccountRevokedStaticSignature
	(*AccountLinkedSIWESignature)(nil),       // 3: xmtp.message_contents.AccountLinkedSIWESignature
	(*Signature_ECDSACompact)(nil),           // 4: xmtp.message_contents.Signature.ECDSACompact
	(*Signature_WalletECDSACompact)(nil),     // 5: xmtp.message_contents.Signature.WalletECDSACompact
	(*AccountLinkedStaticSignature_V1)(nil),  // 6: xmtp.message_contents.AccountLinkedStaticSignature.V1
	(*AccountRevokedStaticSignature_V1)(nil), // 7: xmtp.message_contents.AccountRevokedStaticSignature.V1
	(*AccountLinkedSIWESignature_V1)(nil),    // 8: xmtp.message_contents.AccountLinkedSIWESignature.V1
}
var file_message_contents_signature_proto_depIdxs = []int32{
	4, // 0: xmtp.message_contents.Signature.ecdsa_compact:type_name -> xmtp.message_contents.Signature.ECDSACompact
	5, // 1: xmtp.message_contents.Signature.wallet_ecdsa_compact:type_name -> xmtp.message_contents.Signature.WalletECDSACompact
	6, // 2: xmtp.message_contents.AccountLinkedStaticSignature.v1:type_name -> xmtp.message_contents.AccountLinkedStaticSignature.V1
	7, // 3: xmtp.message_contents.AccountRevokedStaticSignature.v1:type_name -> xmtp.message_contents.AccountRevokedStaticSignature.V1
	8, // 4: xmtp.message_contents.AccountLinkedSIWESignature.v1:type_name -> xmtp.message_contents.AccountLinkedSIWESignature.V1
	0, // 5: xmtp.message_contents.AccountLinkedStaticSignature.V1.signature:type_name -> xmtp.message_contents.Signature
	0, // 6: xmtp.message_contents.AccountRevokedStaticSignature.V1.signature:type_name -> xmtp.message_contents.Signature
	0, // 7: xmtp.message_contents.AccountLinkedSIWESignature.V1.signature:type_name -> xmtp.message_contents.Signature
