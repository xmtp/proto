...
func (x *Signature) GetGenericSignature() *Signature_Generic {
	if x, ok := x.GetUnion().(*Signature_GenericSignature); ok {
...
type Signature_GenericSignature struct {
	GenericSignature *Signature_Generic `protobuf:"bytes,3,opt,name=generic_signature,json=genericSignature,proto3,oneof"`
}
...
func (*Signature_GenericSignature) isSignature_Union() {}
...
type Signature_Generic struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SignatureBytes []byte `protobuf:"bytes,1,opt,name=signature_bytes,json=signatureBytes,proto3" json:"signature_bytes,omitempty"` // signature bytes
	MessageBytes   []byte `protobuf:"bytes,2,opt,name=message_bytes,json=messageBytes,proto3" json:"message_bytes,omitempty"`
	Algorithm      string `protobuf:"bytes,3,opt,name=algorithm,proto3" json:"algorithm,omitempty"` // signature algorithm
	Context        string `protobuf:"bytes,4,opt,name=context,proto3" json:"context,omitempty"`     // context the signature should be trusted for e.g. "sender_key_association"
}

func (x *Signature_Generic) Reset() {
	*x = Signature_Generic{}
	if protoimpl.UnsafeEnabled {
...
func (x *Signature_Generic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Signature_Generic) ProtoMessage() {}

func (x *Signature_Generic) ProtoReflect() protoreflect.Message {
	mi := &file_message_contents_signature_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Signature_Generic.ProtoReflect.Descriptor instead.
func (*Signature_Generic) Descriptor() ([]byte, []int) {
	return file_message_contents_signature_proto_rawDescGZIP(), []int{0, 2}
}

func (x *Signature_Generic) GetSignatureBytes() []byte {
	if x != nil {
...
func (x *Signature_Generic) GetMessageBytes() []byte {
	if x != nil {
...
func (x *Signature_Generic) GetAlgorithm() string {
	if x != nil {
		return x.Algorithm
	}
	return ""
...
func (x *Signature_Generic) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
var file_message_contents_signature_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xc8, 0x04, 0x0a, 0x09, 0x53, 0x69,
	...
	0x6f, 0x6d, 0x70, 0x61, 0x63, 0x74, 0x12, 0x57, 0x0a, 0x11, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x69,
	0x63, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x75, 0x72, 0x65, 0x2e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x48, 0x00, 0x52, 0x10, 0x67,
	0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x1a,
	...
	0x79, 0x1a, 0x46, 0x0a, 0x12, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x45, 0x43, 0x44, 0x53, 0x41,
	...
	,
...
var file_message_contents_signature_proto_goTypes = []interface{}{
	...
	(*Signature_Generic)(nil),            // 3: xmtp.message_contents.Signature.Generic
}
var file_message_contents_signature_proto_depIdxs = []int32{
	...
	3, // 2: xmtp.message_contents.Signature.generic_signature:type_name -> xmtp.message_contents.Signature.Generic
...
func file_message_contents_signature_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_message_contents_signature_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Signature_Generic); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
