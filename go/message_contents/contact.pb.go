...
var file_message_contents_contact_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x6c, 0x65, 0x22, 0x54, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x42,
	...
	0x74, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x56, 0x31, 0x48, 0x00, 0x52, 0x02, 0x76, 0x31, 0x42,
	0x09, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x2b, 0x5a, 0x29, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x78, 0x6d, 0x74, 0x70, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x63,
...
var file_message_contents_contact_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_message_contents_contact_proto_goTypes = []interface{}{
	(*ContactBundleV1)(nil), // 0: xmtp.message_contents.ContactBundleV1
	(*ContactBundle)(nil),   // 1: xmtp.message_contents.ContactBundle
	(*PublicKeyBundle)(nil), // 2: xmtp.message_contents.PublicKeyBundle
}
var file_message_contents_contact_proto_depIdxs = []int32{
	2, // 0: xmtp.message_contents.ContactBundleV1.key_bundle:type_name -> xmtp.message_contents.PublicKeyBundle
	0, // 1: xmtp.message_contents.ContactBundle.v1:type_name -> xmtp.message_contents.ContactBundleV1
...
func file_message_contents_contact_proto_init() {
	...
	file_message_contents_contact_proto_msgTypes[1].OneofWrappers = []interface{}{
