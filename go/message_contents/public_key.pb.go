...
type SignedSendKeyBundle struct {
	...
	// Types that are assignable to Union:
	//
	//	*SignedSendKeyBundle_LegacySendKey
...
func (x *SignedSendKeyBundle) GetLegacySendKey() *SignedPublicKey {
	if x, ok := x.GetUnion().(*SignedSendKeyBundle_LegacySendKey); ok {
		return x.LegacySendKey
	}
	return nil
}
...
type SignedSendKeyBundle_LegacySendKey struct {
	LegacySendKey *SignedPublicKey `protobuf:"bytes,1,opt,name=legacy_send_key,json=legacySendKey,proto3,oneof"`
}

type SignedSendKeyBundle_SendKey struct {
	SendKey *SignedPublicKeyV2 `protobuf:"bytes,2,opt,name=send_key,json=sendKey,proto3,oneof"`
}

type SignedSendKeyBundle_RevokedSendKey struct {
	RevokedSendKey *SignedPublicKeyRevocation `protobuf:"bytes,3,opt,name=revoked_send_key,json=revokedSendKey,proto3,oneof"`
}

func (*SignedSendKeyBundle_LegacySendKey) isSignedSendKeyBundle_Union() {}
...
var file_message_contents_public_key_proto_rawDesc = []byte{
	...
	0x6f, 0x66, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x95, 0x02, 0x0a, 0x13, 0x53, 0x69,
	0x67, 0x6e, 0x65, 0x64, 0x53, 0x65, 0x6e, 0x64, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e, 0x64, 0x6c,
	0x65, 0x12, 0x50, 0x0a, 0x0f, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x5f, 0x73, 0x65, 0x6e, 0x64,
	...
	,
	...
	0x65, 0x22, 0xa3, 0x01, 0x0a, 0x15, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x50, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x12, 0x49, 0x0a, 0x0c, 0x69,
	...
	0x69, 0x74, 0x79, 0x4b, 0x65, 0x79, 0x12, 0x3f, 0x0a, 0x07, 0x70, 0x72, 0x65, 0x5f, 0x6b, 0x65,
	...
	0x06, 0x70, 0x72, 0x65, 0x4b, 0x65, 0x79, 0x22, 0xa5, 0x02, 0x0a, 0x09, 0x50, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61,
	0x6d, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74,
	0x61, 0x6d, 0x70, 0x12, 0x43, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65,
	...
	,
	...
	0x6e, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22,
	0x91, 0x01, 0x0a, 0x0f, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e,
	0x64, 0x6c, 0x65, 0x12, 0x43, 0x0a, 0x0c, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x4b, 0x65, 0x79, 0x12, 0x39, 0x0a, 0x07, 0x70, 0x72, 0x65, 0x5f,
	0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x78, 0x6d, 0x74, 0x70,
	0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x73, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x52, 0x06, 0x70, 0x72, 0x65,
	0x4b, 0x65, 0x79, 0x42, 0x4f, 0x0a, 0x1f, 0x6f, 0x72, 0x67, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e,
...
var file_message_contents_public_key_proto_depIdxs = []int32{
	...
	4,  // 3: xmtp.message_contents.SignedSendKeyBundle.legacy_send_key:type_name -> xmtp.message_contents.SignedPublicKey
	1,  // 4: xmtp.message_contents.SignedSendKeyBundle.send_key:type_name -> xmtp.message_contents.SignedPublicKeyV2
	2,  // 5: xmtp.message_contents.SignedSendKeyBundle.revoked_send_key:type_name -> xmtp.message_contents.SignedPublicKeyRevocation
	12, // 6: xmtp.message_contents.SignedPublicKey.signature:type_name -> xmtp.message_contents.Signature
	4,  // 7: xmtp.message_contents.SignedPublicKeyBundle.identity_key:type_name -> xmtp.message_contents.SignedPublicKey
	4,  // 8: xmtp.message_contents.SignedPublicKeyBundle.pre_key:type_name -> xmtp.message_contents.SignedPublicKey
	12, // 9: xmtp.message_contents.PublicKey.signature:type_name -> xmtp.message_contents.Signature
	9,  // 10: xmtp.message_contents.PublicKey.secp256k1_uncompressed:type_name -> xmtp.message_contents.PublicKey.Secp256k1Uncompressed
	6,  // 11: xmtp.message_contents.PublicKeyBundle.identity_key:type_name -> xmtp.message_contents.PublicKey
	6,  // 12: xmtp.message_contents.PublicKeyBundle.pre_key:type_name -> xmtp.message_contents.PublicKey
...
func file_message_contents_public_key_proto_init() {
	...
	file_message_contents_public_key_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*SignedSendKeyBundle_LegacySendKey)(nil),
