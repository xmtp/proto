...
type UnsignedPublicKey_Secp256K1Uncompressed_ struct {
	Secp256K1Uncompressed *UnsignedPublicKey_Secp256K1Uncompressed `protobuf:"bytes,2,opt,name=secp256k1_uncompressed,json=secp256k1Uncompressed,proto3,oneof"`
}
...
var file_message_contents_public_key_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
