...
type SignedPublicKey struct {
	...
	Signature *Signature        `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`               // signs key_bytes, legacy association proof
	Proof     *AssociationProof `protobuf:"bytes,3,opt,name=proof,proto3" json:"proof,omitempty"`                       // proves association with a user identity
}
...
func (x *SignedPublicKey) GetProof() *AssociationProof {
	if x != nil {
		return x.Proof
	}
	return nil
...
var file_message_contents_public_key_proto_rawDesc = []byte{
	...
	0x22, 0xad, 0x01, 0x0a, 0x0f, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69,
	...
	0x65, 0x12, 0x3d, 0x0a, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
...
var file_message_contents_public_key_proto_goTypes = []interface{}{
	...
	(*AssociationProof)(nil),                        // 8: xmtp.message_contents.AssociationProof
}
var file_message_contents_public_key_proto_depIdxs = []int32{
	...
	8, // 2: xmtp.message_contents.SignedPublicKey.proof:type_name -> xmtp.message_contents.AssociationProof
	1, // 3: xmtp.message_contents.SignedPublicKeyBundle.identity_key:type_name -> xmtp.message_contents.SignedPublicKey
	1, // 4: xmtp.message_contents.SignedPublicKeyBundle.pre_key:type_name -> xmtp.message_contents.SignedPublicKey
	7, // 5: xmtp.message_contents.PublicKey.signature:type_name -> xmtp.message_contents.Signature
	6, // 6: xmtp.message_contents.PublicKey.secp256k1_uncompressed:type_name -> xmtp.message_contents.PublicKey.Secp256k1Uncompressed
	3, // 7: xmtp.message_contents.PublicKeyBundle.identity_key:type_name -> xmtp.message_contents.PublicKey
	3, // 8: xmtp.message_contents.PublicKeyBundle.pre_key:type_name -> xmtp.message_contents.PublicKey
