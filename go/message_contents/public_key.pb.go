...
func (x *SendKey) GetSignedPublicKey() *SignedPublicKeyV2 {
	if x, ok := x.GetUnion().(*SendKey_SignedPublicKey); ok {
...
type SendKey_SignedPublicKey struct {
	SignedPublicKey *SignedPublicKeyV2 `protobuf:"bytes,1,opt,name=signed_public_key,json=signedPublicKey,proto3,oneof"`
}

func (*SendKey_SignedPublicKey) isSendKey_Union() {}
...
type SendKeyRevocation struct {
	...
	// Types that are assignable to Union:
	//
	//	*SendKeyRevocation_SignedRevocation
...
func (x *SendKeyRevocation) GetSignedRevocation() *SignedPublicKeyRevocationV1 {
	if x, ok := x.GetUnion().(*SendKeyRevocation_SignedRevocation); ok {
...
type SendKeyRevocation_SignedRevocation struct {
	SignedRevocation *SignedPublicKeyRevocationV1 `protobuf:"bytes,1,opt,name=signed_revocation,json=signedRevocation,proto3,oneof"`
}

func (*SendKeyRevocation_SignedRevocation) isSendKeyRevocation_Union() {}
...
var file_message_contents_public_key_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x6f, 0x66, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x6a, 0x0a, 0x07, 0x53,
	0x65, 0x6e, 0x64, 0x4b, 0x65, 0x79, 0x12, 0x56, 0x0a, 0x11, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64,
	...
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x56, 0x32, 0x48, 0x00, 0x52, 0x0f, 0x73,
	0x69, 0x67, 0x6e, 0x65, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x42, 0x07,
	0x0a, 0x05, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x22, 0x7f, 0x0a, 0x11, 0x53, 0x65, 0x6e, 0x64, 0x4b,
	0x65, 0x79, 0x52, 0x65, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x61, 0x0a, 0x11,
	...
	0x65, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x31, 0x48, 0x00, 0x52, 0x10, 0x73,
	0x69, 0x67, 0x6e, 0x65, 0x64, 0x52, 0x65, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42,
	0x07, 0x0a, 0x05, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x22, 0x6e, 0x0a, 0x0f, 0x53, 0x69, 0x67, 0x6e,
	0x65, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x6b,
	0x65, 0x79, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08,
	0x6b, 0x65, 0x79, 0x42, 0x79, 0x74, 0x65, 0x73, 0x12, 0x3e, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xa3, 0x01, 0x0a, 0x15, 0x53, 0x69, 0x67,
	0x6e, 0x65, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e, 0x64,
	0x6c, 0x65, 0x12, 0x49, 0x0a, 0x0c, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x6b,
	...
	0x07, 0x70, 0x72, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26,
	...
	0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x52, 0x06, 0x70, 0x72, 0x65, 0x4b, 0x65, 0x79, 0x22, 0xa5,
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x43, 0x0a, 0x09, 0x73, 0x69,
	...
	,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x91, 0x01, 0x0a, 0x0f, 0x50, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x4b, 0x65, 0x79, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x12, 0x43, 0x0a, 0x0c, 0x69, 0x64,
	...
	0x39, 0x0a, 0x07, 0x70, 0x72, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x20, 0x2e, 0x78, 0x6d, 0x74, 0x70, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b,
	0x65, 0x79, 0x52, 0x06, 0x70, 0x72, 0x65, 0x4b, 0x65, 0x79, 0x42, 0x4f, 0x0a, 0x1f, 0x6f, 0x72,
...
var file_message_contents_public_key_proto_depIdxs = []int32{
	...
	1,  // 3: xmtp.message_contents.SendKey.signed_public_key:type_name -> xmtp.message_contents.SignedPublicKeyV2
	2,  // 4: xmtp.message_contents.SendKeyRevocation.signed_revocation:type_name -> xmtp.message_contents.SignedPublicKeyRevocationV1
	13, // 5: xmtp.message_contents.SignedPublicKey.signature:type_name -> xmtp.message_contents.Signature
	...
	13, // 8: xmtp.message_contents.PublicKey.signature:type_name -> xmtp.message_contents.Signature
	10, // 9: xmtp.message_contents.PublicKey.secp256k1_uncompressed:type_name -> xmtp.message_contents.PublicKey.Secp256k1Uncompressed
